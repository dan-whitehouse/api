...
public class ValidationMapper {
    ...
    public org.ricone.api.core.request.validation.model.School mapSchool(School school, int studentEnrollmentCount, int staffAssignmentCount, int courseCount, int rosterCount) {
        org.ricone.api.core.request.validation.model.School instance = new org.ricone.api.core.request.validation.model.School();
