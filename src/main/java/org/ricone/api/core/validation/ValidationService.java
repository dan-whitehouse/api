...
import org.ricone.api.core.validation.model.*;
			...
			try {
				...
				if(CollectionUtils.isNotEmpty(schools)) {
					...
					schools.forEach(school -> {
						...
						org.ricone.api.core.validation.model.School v_school = mapper.mapSchool(school, studentEnrollmentCount, staffAssignmentCount, courseCount, rosterCount);
	...
	public ValidationResponse findAllByLea(MetaData metaData, String refId) throws Exception {
		...
		if(CollectionUtils.isNotEmpty(schools)) {
			...
			for(School sch : schools)
			{
				...
				org.ricone.api.core.validation.model.School v_school = mapper.mapSchool(sch, studentEnrollmentCount, staffAssignmentCount, courseCount, rosterCount);
