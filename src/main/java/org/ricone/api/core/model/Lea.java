...
public class Lea implements java.io.Serializable {
    ...
    public String toString() {
        return "Lea{" + "leaRefId='" + leaRefId + '\'' + ", leaId='" + leaId + '\'' + ", leaSeaId='" + leaSeaId + '\'' + ", leaNcesId='" + leaNcesId + '\'' + ", leaName='" + leaName + '\'' + ", streetNumberAndName='" + streetNumberAndName + '\'' + ", city='" + city + '\'' + ", stateCode='" + stateCode + '\'' + ", postalCode='" + postalCode + '\'' + ", addressCountyName='" + addressCountyName + '\'' + ", leaVendorId='" + leaVendorId + '\'' + ", addressType='" + addressType + '\'' + ", line2='" + line2 + '\'' + ", countryCode='" + countryCode + '\'' + '}';
    }
