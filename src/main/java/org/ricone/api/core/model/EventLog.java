...
public class EventLog implements java.io.Serializable {
    ...
    @Transient
    public CourseSection getRoster() {
        return roster;
    }

    public void setRoster(CourseSection roster) {
        this.roster = roster;
    }
    ...
    public String toString() {
        return "EventLog{" + "eventRefId='" + eventRefId + '\'' + ", eventType='" + eventType + '\'' + ", eventTimestamp=" + eventTimestamp + ", lea='" + lea + '\'' + ", object='" + object + '\'' + ", objectRefId='" + objectRefId + '\'' + '}';
    }
}