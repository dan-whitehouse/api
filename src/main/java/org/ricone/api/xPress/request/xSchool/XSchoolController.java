...
public class XSchoolController extends AbstractController
{
    ...
    {
        SchoolWrapper instance = service.findById(getMetaData(pageRequest), refId);
    ...
    {
        List<SchoolWrapper> instance = service.findAll(getMetaData(pageRequest));
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByLea(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByCalendar(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByCourse(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByRoster(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByStaff(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByStudent(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<SchoolWrapper> instance = service.findAllByContact(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
}