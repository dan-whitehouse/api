...
public class XChangesSinceController extends AbstractController {
    ...
    public Error malformedSyntax(HttpServletRequest request, HttpServletResponse response, Exception ex) {

        //https://spring.io/blog/2013/11/01/exception-handling-in-spring-mvc
        return new Error(request.getRequestURL().toString(), 400, "Bad Request", ex.getCause().getCause().getLocalizedMessage());
    }
}