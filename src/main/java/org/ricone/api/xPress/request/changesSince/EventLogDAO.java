...
public class EventLogDAO extends AbstractDAO<Integer, EventLog> implements IEventLogDAO {
    ...
    public List<EventLogWrapper> findAllByLea(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.LEA), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
    ...
    public List<EventLogWrapper> findAllBySchool(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.SCHOOL), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
    ...
    public List<EventLogWrapper> findAllByCalendar(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.CALENDAR), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
    ...
    public List<EventLogWrapper> findAllByCourse(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.COURSE), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
    ...
    public List<EventLogWrapper> findAllByRoster(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.ROSTER), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
    ...
    public List<EventLogWrapper> findAllByStaff(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.STAFF), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
    ...
    public List<EventLogWrapper> findAllByStudent(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.STUDENT), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
    ...
    public List<EventLogWrapper> findAllByContact(MetaData metaData, LocalDateTime iso8601) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(EventLogWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(OBJECT), EventObject.CONTACT), cb.greaterThanOrEqualTo(from.get(EVENT_TIME_STAMP), iso8601), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(EVENT_TIME_STAMP)));
