...
public class LeaDAO extends AbstractDAO<Integer, Lea> implements ILeaDAO {
    ...
    public List<LeaWrapper> findAllBySchoolRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(schools.get("schoolRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findAllByCalendarRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(schoolCalendars.get("schoolCalendarRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findAllByCourseRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(courses.get("courseRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findAllByRosterRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(courseSections.get("courseSectionRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findAllByStaffRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(staff.get("staffRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findAllByStudentRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(student.get("studentRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findAllByContactRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(contact.get("studentContactRefId"), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<LeaWrapper> findByRefIds(MetaData metaData, Set<String> refIds) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(from.get(PRIMARY_KEY).in(refIds), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
    ...
    public LeaWrapper findByRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(PRIMARY_KEY), refId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
    ...
    public LeaWrapper findByLocalId(MetaData metaData, String localId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(LeaWrapper.class, from.get("leaId"), from));
        select.where(cb.and(cb.equal(from.get(LOCAL_ID_KEY), localId), from.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
