...
public class XLeaController extends AbstractController
{
    ...
    {
        LeaWrapper instance = service.findById(getMetaData(pageRequest), refId);
    ...
    {
        MetaData metaData = getMetaData(pageRequest);
        List<LeaWrapper> instance = service.findAll(metaData);
    ...
    {
        List<LeaWrapper> instance = service.findAllBySchool(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<LeaWrapper> instance = service.findAllByCalendar(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<LeaWrapper> instance = service.findAllByCourse(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<LeaWrapper> instance = service.findAllByRoster(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<LeaWrapper> instance = service.findAllByStaff(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<LeaWrapper> instance = service.findAllByStudent(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
    ...
    {
        List<LeaWrapper> instance = service.findAllByContact(getMetaData(pageRequest), refId);
        return mapper.convert(instance);
    }
}