...
public class StudentDAO extends AbstractDAO<Integer, Student> implements IStudentDAO {
    ...
    public List<StudentWrapper> findAllBySchoolRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(StudentWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(school.get("schoolRefId"), refId), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<StudentWrapper> findAllByRosterRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(StudentWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(courseSection.get("courseSectionRefId"), refId), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public List<StudentWrapper> findAllByContactRefId(MetaData metaData, String refId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(StudentWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(studentContact.get("studentContactRefId"), refId), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
        select.orderBy(cb.asc(from.get(PRIMARY_KEY)));
    ...
    public StudentWrapper findByLocalId(MetaData metaData, String localId) throws NotFoundException {
        ...
        select.distinct(true);
        select.select(cb.construct(StudentWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(studentIdentifiers.get(ID_KEY), localId), cb.equal(studentIdentifiers.get(IDENTIFICATION_SYSTEM_CODE), "District"), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
    ...
    public StudentWrapper findByStateId(MetaData metaData, String stateId) throws Exception {
        ...
        select.distinct(true);
        select.select(cb.construct(StudentWrapper.class, lea.get("leaId"), from));
        select.where(cb.and(cb.equal(studentIdentifiers.get(ID_KEY), stateId), cb.equal(studentIdentifiers.get(IDENTIFICATION_SYSTEM_CODE), "State"), lea.get(MetaData.LEA_LOCAL_ID_KEY).in(metaData.getApp().getDistrictLocalIds())));
